...
# custom events IDs for clor change events
...
class Sprite(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        boundary_hit = False
        # check with collision with left or right boundaries and reverse direction
...
while not exit:
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.QUIT:
            exit = True
        # If the sprite's color change is triggered, change the sprite's color
